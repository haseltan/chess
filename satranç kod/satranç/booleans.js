...
function checkStraightObstacleFree($checkObstacleId) {
	...
	for(firstObstacleLetterBackwards; firstObstacleLetterBackwards > -1; firstObstacleLetterBackwards--){
		/*console.log("Kale kontrol");
		console.log("firstObstacleLetterBackwards:");
		console.log(firstObstacleLetterBackwards);
		console.log("pieceFreeCheckList[firstObstacleLetterBackwards]:")
		console.log(pieceFreeCheckList[firstObstacleLetterBackwards]);
...
function checkPieceFree($piecePlace){
	//console.log("Piece checker kontrolü")
	var pieceChecker = document.getElementById($piecePlace).innerHTML;
	//console.log("pieceChecker");
	//console.log(pieceChecker);
	if (pieceChecker) {
		//console.log("False geçti");
		pieceFreeCheckList[pieceFreeCounter] = false;
	} else {
		//console.log("True geçti");
...
function whiteTurn() {
	BblackTurn = false;
	BwhiteTurn = true;
	document.getElementById("hamle").innerHTML = "Hamle sirasi beyazda."
	BwhiteTurn2 = true;
}
...
function blackTurn() {
    BwhiteTurn = false;
	BblackTurn = true;
	document.getElementById("hamle").innerHTML = "Hamle sirasi siyahta."
	BblackTurn2 = true;
}
