function endTheGame(){
	...
	document.getElementById("a6").onclick= "";
	...
	document.getElementById("d5").onclick= "";
	...
	document.getElementById("f4").onclick= "";
	document.getElementById("f5").onclick= "";
	document.getElementById("f6").onclick= "";
	document.getElementById("f7").onclick= "";
	document.getElementById("f8").onclick= "";
	...
	document.getElementById("g5").onclick= "";
	document.getElementById("g6").onclick= "";
	document.getElementById("g7").onclick= "";
	document.getElementById("g8").onclick= "";
	
	document.getElementById("i1").onclick= "";
	document.getElementById("i2").onclick= "";
	document.getElementById("i3").onclick= "";
	document.getElementById("i4").onclick= "";
	document.getElementById("i5").onclick= "";
	document.getElementById("i6").onclick= "";
	document.getElementById("i7").onclick= "";
	document.getElementById("i8").onclick= "";
}